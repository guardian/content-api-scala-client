...
/** In order to send bulk-queries that are *not* too big (ie no request bigger than
  * [[integration.capi.bulkqueries.RequestSizing.MaxCapiUriLength]]), we need to know how much space in the
  * url is:
  *
...
trait RequestSizing {
  ...
  /** @return
    *   the length of the part of the url that counts towards the
    *   [[integration.capi.bulkqueries.RequestSizing.MaxCapiUriLength]] - ie the path & query params, without
